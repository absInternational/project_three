...
<script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.js"></script>
    ...
    <div class="page-header">
        <div class="text-secondary text-center text-uppercase w-100">
            <h1 class="my-4"><b>Add Port Price</b></h1>
        </div>
    </div>
    <!--End Page header-->
    <!-- Row -->
    <div class="row">
        ...
        <!--div-->
            <div class="card">
                ...
                <form action="{{ url('/port_price/store') }}" method="POST">
                    <div class="card-body">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote" name="long_data" placeholder="Create Port Price"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
