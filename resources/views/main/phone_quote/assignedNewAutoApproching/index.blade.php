    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                    ...
                    <div class="card-header">
                        <div class="container-fluid">
                            <div class="col-lg-12 p-0">
                                <?php
                                $datas = \App\ShipperDetails::select('states', 'id')->where('states', '!=', '-')->groupBy('states')->orderBy('states', 'asc')->get();
                                ...
                                $company = \App\ShipperDetails::with('user')->has('user')->get();
                ...
                <div class="card-body">
                    <div id="table_data">
                        @include('main.phone_quote.assignedNewAutoApproching.table')
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            function filterData() {
                ...
                var url = "{{ route('filter.assigned.autos_approach_new') }}";
