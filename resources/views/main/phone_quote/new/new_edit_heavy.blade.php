...
@section('content')
                                        ...
                                        <div class="col-sm-12 buyer_number">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="obuyer_no" id="obuyer_no"
                                                    class="form-control this_save " placeholder="Buyer/Lot/Stock Number"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control this_save" autocomplete="off" type="date"
                                                    name="oacutiondate" id="oacutiondate" value="{{ $data->oauctiondate }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                ...
                                <div class="row mb-2" id="ophoneResult">
                                    <div class="col-lg-12" style=" padding-left: 26px !important; ">
                                        ...
                                        <a href="javascript:void(0)" data-toggle="modal"
                                            data-target="#alreadyCreditCard">{{ $credit_card + count($old) }} Card
                                            Found</a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id='dname' name='dname'
                                                class="form-control this_save " value="{{ $data->dname }}"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label font-boldd">Email Address</label>
                                            <input type="email" name="oemail" id="demail" autocomplete="of"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <select id="trailter_type" name="trailter_type[]"
                                class="form-control this_save vehicle-type">
                                <option value="FLATBED (F)" @if ($data->type == 'FLATBED (F)') selected @endif>FLATBED (F)
                                </option>
                                <option value="STEP DECK (SD)" @if ($data->type == 'STEP DECK (SD)') selected @endif>STEP
                                    DECK (SD)</option>
                                <option value="REMOVABLE GOOSENECK (RGN)"
                                    @if ($data->type == 'REMOVABLE GOOSENECK (RGN)') selected @endif>REMOVABLE GOOSENECK (RGN)</option>
                                <option value="CONESTOGA (CS)" @if ($data->type == 'CONESTOGA (CS)') selected @endif>
                                    CONESTOGA (CS)</option>
                                <option value="TRUCK (T)" @if ($data->type == 'TRUCK (T)') selected @endif>TRUCK (T)
                                </option>
                                <option value="POWER ONLY (PO)" @if ($data->type == 'POWER ONLY (PO)') selected @endif>POWER
                                    ONLY (PO)</option>
                                <option value="HOT SHOT (HS)" @if ($data->type == 'HOT SHOT (HS)') selected @endif>HOT SHOT
                                    (HS)</option>
                                <option value="LOWBOY (LB)" @if ($data->type == 'LOWBOY (LB)') selected @endif>LOWBOY (LB)
                                </option>
                                <option value="ENDUMP (ED)" @if ($data->type == 'ENDUMP (ED)') selected @endif>ENDUMP (ED)
                                </option>
                                <option value="LANDOLL (LD)" @if ($data->type == 'LANDOLL (LD)') selected @endif>LANDOLL
                                    (LD)</option>
                                <option value="PARTIAL (PT)" @if ($data->type == 'PARTIAL (PT)') selected @endif>PARTIAL
                                    (PT)</option>
                            </select>
                        </div>
                    </div>
                    @php
                        ...
                        $arraylength = explode('*^', $data->length_ft);
                        $arraylength_in = explode('*^', $data->length_in);
                        $arraywidth_ft = explode('*^', $data->width_ft);
                        $arraywidth_in = explode('*^', $data->width_in);
                        $arrayheight_ft = explode('*^', $data->height_ft);
                        $arrayheight_in = explode('*^', $data->height_in);
                        $arrayweight = explode('*^', $data->weight);
                        ...
                        $arrayloadmethod = explode('*^', $data->load_method);
                        $arrayunloadmethod = explode('*^', $data->unload_method);

                        $category = explode('*^', $data->category);
                        $subcategory = explode('*^', $data->subcategory);

                        $rv_type = explode('*^', $data->rv_type);
                    ...
                    @foreach ($arrayopt as $arraydata)
                        ...
                        @if (empty($arraylength[$i]))
                            @php $arraylength[$i] = "" @endphp
                        @endif
                        @if (empty($arraylength_in[$i]))
                            @php $arraylength_in[$i] = "" @endphp
                        @endif
                        @if (empty($arraywidth_ft[$i]))
                            @php $arraywidth_ft[$i] = "" @endphp
                        @endif
                        @if (empty($arraywidth_in[$i]))
                            @php $arraywidth_in[$i] = "" @endphp
                        @endif

                        @if (empty($arrayheight_ft[$i]))
                            @php $arrayheight_ft[$i] = "" @endphp
                        @endif
                        @if (empty($arrayheight_in[$i]))
                            @php $arrayheight_in[$i] = "" @endphp
                        @endif
                        @if (empty($arrayweight[$i]))
                            @php $arrayweight[$i] = "" @endphp
                        @endif
                        @if (empty($arrayloadmethod[$i]))
                            @php $arrayloadmethod[$i] = "" @endphp
                        @endif
                        @if (empty($arrayunloadmethod[$i]))
                            @php $arrayunloadmethod[$i] = "" @endphp
                        @endif
                        @if (empty($category[$i]))
                            @php $category[$i] = "" @endphp
                        @endif
                        @if (empty($subcategory[$i]))
                            @php $subcategory[$i] = "" @endphp
                        @endif
                        @if (empty($rv_type[$i]))
                            @php $rv_type[$i] = "" @endphp
                        @endif
                        ...
                        <div @if ($i > 0) class="vehicle_add" @endif>
                                ...
                                <div class="vichle__Information--box">
                                    <div class="">
                                        <label class="rdiobox">
                                            ...
                                            <input name="vehicle_v[]" id="vehicle_v{{ $i }}" type="hidden"
                                                <?php if ($arrayopt2[$i] == 'vin' || $arrayopt2[$i] == '2') {
                                                    echo 'disabled';
                                                } ?> value="make">
                            ...
                            <div class="row">
                                ...
                                <div class="input-group vin_show<?php echo $i; ?>"
                                    ...
                                    <input required class="form-control this_save" type="text"
                                ...
                                <div class="col-sm-6 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required class="form-control this_save  model0 vmodel"
                                            id='model{{ $i }}' onkeyup="getmodel({{ $i }})"
                                            name='vmodel[]' value="{{ $arraymodel[$i] }}" placeholder="Enter Model"
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label class="form-control-label font-weight-bold tx-black">Width </label>
                                        <div class="row">
                                            <div class="col-lg-6 pd-r-0">
                                                <input type="text" class="form-control this_save" placeholder="ft."
                                                    name="widthft[]" id="widthft{{ $i }}"
                                                    value="{{ $arraywidth_ft[$i] }}">
                                            </div>
                                            <div class="col-lg-6 pd-l-0">
                                                <input type="text" class="form-control this_save" placeholder="in."
                                                    name="widthin[]" id="widthin{{ $i }}"
                                                    value="{{ $arraywidth_in[$i] }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 pd-r-0">
                                                <input type="text" class="required form-control this_save"
                                                    placeholder="ft." name="heigthft[]" id="heigthft{{ $i }}"
                                                    value="{{ $arrayheight_ft[$i] }}">
                                            </div>
                                            <div class="col-lg-6 pd-l-0">
                                                <input type="text" class="required form-control this_save"
                                                    placeholder="in." name="heigthin[]" id="heigthin{{ $i }}"
                                                    value="{{ $arrayheight_in[$i] }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label class="form-control-label font-weight-bold tx-black">Weight </label>
                                        <input type="text" class="required form-control this_save" name="weight[]"
                                            id="weight{{ $i }}" value="{{ $arrayweight[$i] }}">
                                    </div>
                                </div>

                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label class="form-control-label font-weight-bold tx-black">Equipment
                                            Condition</label>
                                        <select id="condition{{ $i }}" name="condition[]"
                                            ...
                                            <option <?php if ($arraycondition[$i] == '3') {
                                                echo 'selected';
                                            } ?> value="3">
                                                Its Roll
                                            </option>
                                ...
                                {{-- <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label class="form-control-label font-weight-bold tx-black">Trailer Type
                                        </label>
                                        <select id="trailter_type{{$i}}" name="trailter_type[]"
                                                class="form-control this_save trailer-type">
                                            <option selected="" value="">Select</option>
                                            <option
                                                @if ($arraytrailertype[$i] == '1') selected @endif value="1">
                                                Open
                                            </option>
                                            <option
                                                @if ($arraytrailertype[$i] == '2') selected @endif value="2">
                                                Enclosed
                                            </option>
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label class="form-control-label font-weight-bold tx-black">Load Method </label>
                                        <select id="load_method{{ $i }}" name="load_method[]"
                                            class="form-control this_save">
                                            <option selected="" value="">Select</option>
                                            <option <?php if ($arrayloadmethod[$i] == 'LOADING DOCK') {
                                                echo 'selected';
                                            } ?> value="LOADING DOCK">
                                                LOADING DOCK
                                            </option>
                                            <option <?php if ($arrayloadmethod[$i] == 'CRANE') {
                                                echo 'selected';
                                            } ?> value="CRANE">
                                                CRANE
                                            </option>
                                            <option <?php if ($arrayloadmethod[$i] == 'FORKLIFT') {
                                                echo 'selected';
                                            } ?> value="FORKLIFT">
                                                FORKLIFT
                                            </option>
                                            <option <?php if ($arrayloadmethod[$i] == 'DRIVE ROLL') {
                                                echo 'selected';
                                            } ?> value="DRIVE ROLL">
                                                DRIVE ROLL
                                            </option>
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label class="form-control-label font-weight-bold tx-black">Unload Method </label>
                                        <select id="unload_method{{ $i }}" name="unload_method[]"
                                            class="form-control this_save">
                                            <option selected="" value="">Select</option>
                                            <option <?php if ($arrayunloadmethod[$i] == 'LOADING DOCK') {
                                                echo 'selected';
                                            } ?> value="LOADING DOCK">
                                                LOADING DOCK
                                            </option>
                                            <option <?php if ($arrayunloadmethod[$i] == 'CRANE') {
                                                echo 'selected';
                                            } ?> value="CRANE">
                                                CRANE
                                            </option>
                                            <option <?php if ($arrayunloadmethod[$i] == 'FORKLIFT') {
                                                echo 'selected';
                                            } ?> value="FORKLIFT">
                                                FORKLIFT
                                            </option>
                                            <option <?php if ($arrayunloadmethod[$i] == 'DRIVE ROLL') {
                                                echo 'selected';
                                            } ?> value="DRIVE ROLL">
                                                DRIVE ROLL
                                            </option>
                                ...
                                @if ($data->heavy_type == 'boat')
                                    <div class="col-sm-3 col-md-3">
                                        <div class="form-group">
                                            <label class="form-control-label font-weight-bold tx-black">Category</label>
                                            <select id="" name="category" class="form-control this_save">
                                                <option value="" disabled selected>Select</option>
                                                <option value="Power Boat"
                                                    @if ($data->category == 'Power Boat') selected @endif>Power Boat</option>
                                                <option value="Sail Boat"
                                                    @if ($data->category == 'Sail Boat') selected @endif>Sail Boat</option>
                                                <option value="Personal Watercraft"
                                                    @if ($data->category == 'Personal Watercraft') selected @endif>Personal Watercraft
                                                </option>
                                                <option value="Boat Parts"
                                                    @if ($data->category == 'Boat Parts') selected @endif>Boat Parts</option>
                                                <option value="Motor Boat"
                                                    @if ($data->category == 'Motor Boat') selected @endif>Motor Boat</option>
                                                <option value="Others" @if ($data->category == 'Others') selected @endif>
                                                    Others</option>
                                            </select>
                                        </div>
                                    </div>
                                @else
                                    <div class="col-sm-3 col-md-3">
                                        <div class="form-group">
                                            <label class="form-control-label font-weight-bold tx-black">Category</label>
                                            <input type="text" id="" class="form-control this_save"
                                                name="category[]" value="{{ $category[$i] }}">
                                    ...
                                    <div class="col-sm-3 col-md-3">
                                        <div class="form-group">
                                            <label class="form-control-label font-weight-bold tx-black">Subcategory</label>
                                            <input type="text" id="" class="form-control this_save"
                                                name="subcategory[]" value="{{ $subcategory[$i] }}">
                                ...
                                @if ($data->heavy_type == 'RV')
                                    <div class="col-sm-3 col-md-3">
                                        <div class="form-group">
                                            <label class="form-control-label font-weight-bold tx-black">RV Type</label>
                                            <select id="rv_type" name="rv_type[]" class="form-control this_save">
                                                <option value="" disabled>Select</option>
                                                <option value="Class A Motorhome"
                                                    @if ($rv_type[$i] == 'Class A Motorhome') selected @endif>Class A Motorhome
                                                </option>
                                                <option value="Class B Motorhome"
                                                    @if ($rv_type[$i] == 'Class B Motorhome') selected @endif>Class B Motorhome
                                                </option>
                                                <option value="Class C Motorhome"
                                                    @if ($rv_type[$i] == 'Class C Motorhome') selected @endif>Class C Motorhome
                                                </option>
                                                <option value="Travel Trailer"
                                                    @if ($rv_type[$i] == 'Travel Trailer') selected @endif>Travel Trailer
                                                </option>
                                                <option value="Folding Tent Trailer"
                                                    @if ($rv_type[$i] == 'Folding Tent Trailer') selected @endif>Folding Tent Trailer
                                                </option>
                                                <option value="Fifth-Wheel"
                                                    @if ($rv_type[$i] == 'Fifth-Wheel') selected @endif>Fifth-Wheel</option>
                                                <option value="Truck Camper"
                                                    @if ($rv_type[$i] == 'Truck Camper') selected @endif>Truck Camper
                                                </option>
                                                <option value="Others" @if ($rv_type[$i] == 'Others') selected @endif>
                                                    Other</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    ...
                                    &nbsp;
                                    <?php
                                    if ($arraytrailerporttitle[$i] == 'true') {
                                        $value = 'true';
                                    } else {
                                        $value = 'false';
                                    }
                                    ...
                                    <div class="form-group">
                                        <label class="ckbox">
                                            <input class="this_save" type="checkbox" name="portTitle{{ $i }}"
                                                id="needTitle{{ $i }}" <?php if ($arraytrailerporttitle[$i] == 'true') {
                                                    echo 'checked';
                                                } ?>
                                                onclick="goto_port({{ $i }})"><span>&nbsp;Need Title?</span>
                                            <input type="hidden" name="portTitlehidden[]"
                                                id="portTitlehidden{{ $i }}" value="<?php echo $value; ?>">
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 ">
                        <div class="form-group">
                            ...
                            <textarea type="text" name='addition_info' id='addition_info' class="form-control this_save " placeholder="">{{ $data->add_info }}</textarea>
                ...
                <div class="row px-4 mx-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-form div-link" @if ($data->link == null) style="display: none;" @endif>
                            ...
                            <div class="form-group">
                                <label class="ckbox">
                                    <input class="this_save" type="checkbox" name="boat_on_trailer" id="boat_on_trailer"
                                        value="yes" @if ($data->boat_on_trailer != null) checked @endif
                                        data-parsley-multiple="boat_on_trailer">
                                    <span>&nbsp;Is your boat on trailer?</span>
                                </label>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class='row'>
                                        @if (Auth::user()->userRole->name != 'Dispatcher')
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input required
                                                    onkeypress="$(this).css('border-color', 'rgb(92 166 242)');"
                                                    type="text" placeholder="ORDER BOOKING PRICE *" id='orderPrice'
                                                    <?php echo $readonly; ?> name='price' value="{{ $data->payment }}"
                                                    class="form-control parsley-error this_save ">
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" placeholder="Coupon Number" id='coupon_number'
                                                value="{{ $coupon_number }}" name='coupon_number'
                                                class="form-control">
                                            @if ($coupon_price > 0)
                                                <div class="alert text-success p-0"><strong>${{ $coupon_price }} Coupon
                                                        applied!</strong></div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    @if (!empty($data->need_deposit))
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input <?php echo $readonly; ?> class="form-control this_save "
                                                autocomplete="nope" type="text" required name="depositAmount"
                                                value="{{ $data->deposit_amount }}" placeholder=""
                                    ...
                                    <div class="col-sm-3"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select <?php echo $disable; ?> id="pay_by" name="pay_by"
                                                ...
                                                <option @if ($data->pay_by == 'Driver') selected="selected" @endif
                                                    value="Driver">Driver
                                                </option>
                                                <option @if ($data->pay_by == 'Customer') selected="selected" @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input <?php echo $readonly; ?> class="form-control this_save "
                                                    ...
                                                    value="{{ $data->other_fees }}" placeholder="" id="other_fees">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input <?php echo $readonly; ?> class="form-control this_save " autocomplete="nope"
                                            type="text" name="pay_carrier" value="{{ $data->pay_carrier }}"
                                            placeholder="" id="payCarrier">
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input <?php echo $readonly; ?> class="form-control this_save " autocomplete="nope"
                                            style="width: 80%" type="text" name="cod_cop"
                                            value="{{ $data->cod_cop }}" placeholder="" id="copcodAmount">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input <?php echo $readonly; ?> class="form-control this_save " type="text"
                                            name="balance" value="{{ $data->balance }}" readonly=""
                                ...
                                <div id="balPart"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select <?php echo $disable; ?> id="balance_method" name="balance_method"
                                            ...
                                            <option @if ($data->balance_method == 'Comchek') selected @endif value="Comchek">
                                                Comchek
                                            </option>
    ...
    <div id="btn_pstatus" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
                    ...
                    <div class="col-sm-12 col-md-12 ">
                        <div class="form-group">
                            <select name="pstatus"
                                ...
                                id="pstatus" required="" class="form-control this_save" tabindex="-1"
                                aria-hidden="true">
                                <option value="" selected disabled>Select</option>
...
@section('extraScript')
    ...
    <script>
        ...
        $("#previousRecord").click(function() {
            ...
            if (ozip == '' || dzip == '') {
                ...
                window.open(url, 'Previous Orders',
                    'height=600,width=1000,left=350,top=350,toolbar=No,location=No,scrollbars=Yes,status=No,resizable=Yes,fullscreen=No,directories=No,menubar=No,copyhistory=No'
                );
            }
        });
    ...
    <script type="text/javascript">
        ...
        $(".add_phone_btn").click(function() {
            $(".add_phone").append(
                '<div class="col-12 add margin_lft"><div class="row"><div class="col-11"><label class="form-label font-boldd">Phone Number: </label><input  type="text" name="ophone[]"  class="form-control this_save ophone ophone_new" id="ophonee' +
                Ophone_count +
        ...
        $(".add_dphone_btn").click(function() {
            $(".add_dphone").append(
                '<div class="col-12 add margin_lft"><div class="row"><div class="col-11"><label class="form-label font-boldd">Phone Number:</label><input  type="text" name="dphone[]"  class="form-control this_save dphone ophone_new" id="phonee' +
                Dphone_count +
...
<div class="vehicle_add">
    ...
    <script>
        $(document).ready(function() {
            var selectedCategory = $('#categoryVal').val();
            var selectedSubcategory = $('#subcategoryVal').val();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        var isSelected = value.name === selectedCategory ? 'selected' : '';
                        categorySelect.append('<option value="' + value.name + '" data-id="' +
                            value.id + '" ' + isSelected + '>' + value.name + '</option>');
                    });
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            subcategorySelect.append(
                                '<option selected disabled>Select</option>');
                            $.each(data, function(key, value) {
                                var isSelected = value.name === selectedSubcategory ?
                                    'selected' : '';
                                subcategorySelect.append('<option value="' + value
                                    .name + '" ' + isSelected + '>' + value.name +
                                    '</option>');
                            });
                        }
                    });
