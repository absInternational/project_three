...
@section('content')
    ...
    <div class="page-header">
        ...
        <!--        </li>-->
        <!--        <li class="breadcrumb-item active" aria-current="page"><a href="#">First Bonus</a></li>-->
        <!--    </ol>-->
        <!--</div>-->
        <div class="text-secondary text-center text-uppercase w-100">
            <h1 class="my-4"><b>First Bonus</b></h1>
        </div>
    ...
    <form name="passform" action="/first_bonus_2" method="post">
        @csrf
        Enter Password:
    ...
    <div class="container table_body row" style=" position: relative; place-items: center; place-content: center; ">
        ...
        if($display=='yes'){
        ?>
        <form action="/save_first_bonus" method="post">
            @csrf
    ...
    <script>
        $("#append").click(function (e) {
            ...
            var markup =
                ...
                "<td><div class='col-lg-12'><div class='form-group2'><label class='form-control-label font-weight-bold tx-black'>Remove</label><div class='input-group'><input value='x' type='button' style=\" background: #e84139; \" class='form-control btn btn-danger remove_this'></div></div></div></td></tr>";
            $("#ajao").append(markup);
