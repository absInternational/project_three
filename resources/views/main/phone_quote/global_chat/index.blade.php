...
@section('content')
    ...
    <div class="page-header">
        ...
        <!--    <ol class="breadcrumb">-->
        <!--        <li class="breadcrumb-item"><a href="#"><i class="fe fe-grid mr-2 fs-14"></i>Home</a></li>-->
                ...
                <div class="tile tile-alt mb-0" id="messages-main" style="width: 100%">
                    <div class="ms-menu">
                        ...
                        <div class="tab-content" id="getChatList">
                            @include('main.phone_quote.global_chat.chat-list')
