    ...
    <div class="slim-mainpanel" style=" padding-left: 0px !important; ">
        <div class="container">
            ...
            <div class="section-wrapper">
                <h1 class="text-primary">	LUXURY VEHICLE</h1>
                <div>
                    <p>• A (C O I) CERTIFICATE OF INSURANCE IS MANDATORY BEFORE DISPATCHING ANY LUXURY VEHICLE</p>

                    <p>• LUXURY VEHICLES MUST BE DISPATCHED WITH (C O I) CERTIFICATE OF INSURANCE</p>
