...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="text-secondary text-center text-uppercase w-100">
            <h1 class="my-4"><b>Roro Invoice List</b></h1>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <?php if($display=='no'){ ?>
                <form name="passform" action="/invoice_list_roro_2" method="post">
                    @csrf
                    Enter Password:
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <a type="button" href="{{url('invoice_add_roro')}}"
                ...
                <div class="card-body">
                    <div id="table_data">
                        ...
                        @include('main.phone_quote.management.loadroro')
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function () {
            ...
            function fetch_data3(page) {
                ...
                $.ajax({
                    ...
                    url: "/invoice_list_roro?page=" + page,
