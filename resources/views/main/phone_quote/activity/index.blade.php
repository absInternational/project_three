...
<style>
    ...
    <div class="page-header">
        ...
        <!--        </li>-->
        <!--        <li class="breadcrumb-item active" aria-current="page"><a href="#">ACTIVITY</a></li>-->
        <!--    </ol>-->
        <!--</div>-->
        <div class="text-secondary text-center text-uppercase w-100">
            <h1 class="my-4"><b>Total Activity</b></h1>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="table_data">
                        ...
                        @include('main.phone_quote.activity.load')
                    </div>
                </div>
            </div>
