            ...
            <tr>
                ...
                <td>
                    ...
                    <strong><i class="fa fa-location-arrow" style="color:green;" aria-hidden="true"></i>
                        ...
                        ?>
                        <a class="@if($rest<>'NA') btn btn-outline-success btn-sm @endif" data-toggle="tooltip"
                           data-placement="bottom"
                           title="<?php echo $val->oaddress ?>">
                            <?php echo $rest ?>
                        </a>
                    </strong>
                    <br>
                ...
                <td>
                    ...
                    <strong><i class="fa fa-location-arrow" style="color:red;" aria-hidden="true"></i>
                        ...
                        ?>
                        <a class="@if($rest<>'NA') btn btn-outline-danger btn-sm @endif" data-toggle="tooltip"
                           data-placement="bottom"
                           title="<?php echo $val->daddress ?>">
                            <?php echo $rest ?>
                        </a>
                    </strong>
                    <br>
                ...
                <td>
                    ...
                    <span class="badge badge-pill badge-default mt-2">By: {{get_user_name($val->order_taker_id)}}</span>
                </td>
