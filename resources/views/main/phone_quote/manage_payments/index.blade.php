    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Completed Orders</a></li>
            </ol>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <center>
                        <h3><mark>Completed Orders</mark></h3>
                    </center>
                </div>
                <div class="card-body">
                    <div id="table_data">

                        @include('main.phone_quote.manage_payments.load')
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="tab-pane active " id="tab1">
                                                                            ...
                                                                            <div class="card">
                                                                                ...
                                                                                <div class="card-body">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <label>Storage</label>
                                                                                            <input class="form-control" id="auc_storage1" name="auc_storage1" placeholder="Storage" required value="">
                                                                                        </div>
                                                                                        <div class="col-md-6">
                                                                                            <label>Vehicle Condition</label>
                                                                                            <input class="form-control" id="auc_condition1" placeholder="Vehicle Condition" required name="auc_condition1" value="">
                                                                                        </div>
                                                                                        <div class="col-md-6">
                                                                                            <label>Title</label>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            <label>Additional</label>
                                                                                            <input class="form-control" id="auc_additional1" placeholder="Additional" required name="auc_additional1" value="">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="card-body">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            ...
                                                                                            <input class="form-control driverphoneno" id="auc_driver_no" name="auc_driver_no" placeholder="Driver No1#" required value="${phone1}">
                                                                                        </div>
                                                                                        <div class="col-md-3">
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            ...
                                                                                            <input class="form-control" id="auc_delivery_date" type="datetime-local"  placeholder="Delivery Datetime" required name="auc_delivery_date"
                                                                                                   value="">
                                                                                        </div>
                                                                                        <div class="col-md-3">
                                                                                            <label>Vehicle Condition</label>
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            <label>Vehicle Position</label>
                                                                                            <input id="auc_vehicle_position" name="auc_vehicle_position" class="form-control" placeholder="Vehicle Position" required value="">
                                                                                        </div>
                                                                                        <div class="col-md-3">
                                                                                            <label>Payment</label>
                                        ...
                                        @if (\Request::is('onapproval'))
                                            <form method="post" action="{{ route('call_history_post') }}"
                                                ...
                                                <div class="row">
                                                    <input type="hidden" class="form-control" name="order_id1"
                                                        value="" id='order_id1' placeholder="" readonly>
        ...
        $(document).ready(function() {
            ...
            function fetch_data3(page) {
                ...
                $.ajax({
                    ...
                    url: "/fetch_manage_payments?page=" + page,
                    success: function(data) {
                        $('#table_data').html('');
                        $('#table_data').html(data);
