...
@section('content')
    ...
    <div class="page-header">
        <div class="text-secondary text-center text-uppercase w-100">
            <h1 class="my-4"><b>Edit Role</b></h1>
        </div>
    </div>
    <!--End Page header-->
    <!-- Row -->
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <form action="{{ url('/role/update/' . $data->id) }}" method="POST">
                    <div class="card-body">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                        ...
                        $emp_action = [];
                        $emp_report = [];
                        if (isset($data->access->phone_access)) {
                            $emp_access_phone = $data->access->phone_access;
                            $emp_access_phone = explode(',', $emp_access_phone);
                        }
                        if (isset($data->access->web_access)) {
                            $emp_access_web = $data->access->web_access;
                            $emp_access_web = explode(',', $emp_access_web);
                        }
                        if (isset($data->access->test_access)) {
                            $emp_access_test = $data->access->test_access;
                            $emp_access_test = explode(',', $emp_access_test);
                        }
                        if (isset($data->access->test_access)) {
                            $panel_type_4 = $data->access->panel_type_4;
                            $panel_type_4 = explode(',', $panel_type_4);
                        }
                        if (isset($data->access->test_access)) {
                            $panel_type_5 = $data->access->test_access;
                            $panel_type_5 = explode(',', $panel_type_5);
                        }
                        if (isset($data->access->test_access)) {
                            $panel_type_6 = $data->access->test_access;
                            $panel_type_6 = explode(',', $panel_type_6);
                        }
                        if (isset($data->access->show_data_access)) {
                            $emp_show_data = $data->access->show_data_access;
                            $emp_show_data = explode(',', $emp_show_data);
                        }
                        if (isset($data->access->shipment_status_access)) {
                            $emp_shipment_status = $data->access->shipment_status_access;
                            $emp_shipment_status = explode(',', $emp_shipment_status);
                        }
                        if (isset($data->access->profile_access)) {
                            $emp_profile = $data->access->profile_access;
                            $emp_profile = explode(',', $emp_profile);
                        }
                        if (isset($data->access->emp_access_action)) {
                            $emp_action = $data->emp_access_action;
                            $emp_action = explode(',', $emp_action);
                        }
                        if (isset($data->access->emp_access_report)) {
                            $emp_report = $data->emp_access_report;
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="5"><label class="ml-2" for="emp_access_web5">No
                                                            Response</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                        ...
                        <div class="modal fade" id="exampleModal20" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document" style="max-width: 60%;">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel20">Role Access (Testing Qoutes)
                                        </h5>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="29"><label class="ml-2"
                                                            for="emp_access_test29">Delivered Approval</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="70"><label class="ml-2"
                                                            for="emp_access_test70">Approaching Search Filter</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="89"><label class="ml-2"
                                                            for="emp_access_test89">Payment System Advance Filter</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="29"><label class="ml-2"
                                                            for="panel_type_429">Delivered Approval</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="70"><label class="ml-2"
                                                            for="panel_type_470">Approaching Search Filter</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="89"><label class="ml-2"
                                                            for="panel_type_489">Payment System Advance Filter</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="29"><label class="ml-2"
                                                            for="panel_type_529">Delivered Approval</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="70"><label class="ml-2"
                                                            for="panel_type_570">Approaching Search Filter</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="89"><label class="ml-2"
                                                            for="panel_type_589">Payment System Advance Filter</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="29"><label class="ml-2"
                                                            for="panel_type_629">Delivered Approval</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="70"><label class="ml-2"
                                                            for="panel_type_670">Approaching Search Filter</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="89"><label class="ml-2"
                                                            for="panel_type_689">Payment System Advance Filter</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="2"><label class="ml-2"
                                                            for="emp_access_action2">Move To Schedule For Delivery</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
                                                            ...
                                                            value="7"><label class="ml-2"
                                                            for="emp_access_action7">Send Payment Link To Customer</label>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="checkbox"
