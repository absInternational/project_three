...
@section('template_title')
    {{  ucfirst(trim('Achievement Sheet','/'))}}
@endsection
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="text-secondary text-center text-uppercase w-100">
            <h1 class="my-4"><b>Achievement Sheet</b></h1>
            @if (in_array('107', $phoneaccess) || Auth::user()->role  ==1 )
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif
            <br>
            <iframe style="width:100%;height:1000px;border: 1px solid grey;" src="{{$data->link}}"></iframe>
        </div>
    </div><!-- end app-content-->
...
@section('extraScript')
    <script>
        ...
        $(document).on('contextmenu', function () {
            alert('You are being track do not access without permission');
            return false;
        });
