...
@section('content')
    ...
    <div class="page-header">
        <div class="text-secondary text-center text-uppercase w-100">
            <h1 class="my-4"><b>All Delivery Boy</b></h1>
        </div>
    </div>
                ...
                <div class="card-header">
                    <div class="container-fluid">
                        <div class="d-flex justify-content-between">
                            <h3 class="my-auto">All Delivery Boy</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-sm" style="width:100%" role="grid">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">Per Review</th>
                                    <th class="border-bottom-0">Private Pickup</th>
                            ...
                            <tbody>
                                @foreach ($data as $key => $val)
                                    <tr>
                                        ...
                                        <td>{{ $val->month }}</td>
                                        <td>{{ $val->no_of_rating }}</td>
                                        <td>{{ $val->no_of_pickup }}</td>
                                        <td>
                                            <div class="btn-group">
                ...
                <form id="addForm">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="user_id">Select Delivery Boy</label>
                        ...
                        <div class="form-group">
                            <label for="no_of_rating">Per Rating</label>
                            <input type="text" class="form-control" id="no_of_rating" name="no_of_rating">
                        </div>
                        <div class="form-group">
                            <label for="no_of_pickup">Private Pickup</label>
                            <input type="text" class="form-control" id="no_of_pickup" name="no_of_pickup">
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form id="editForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_no_of_rating">Per Rating</label>
                            <input type="text" class="form-control" id="edit_no_of_rating" name="no_of_rating">
                        </div>
                        <div class="form-group">
                            <label for="edit_no_of_pickup">Private Pickup</label>
                            <input type="text" class="form-control" id="edit_no_of_pickup" name="no_of_pickup">
                        </div>
                        <div class="form-group">
            ...
            $('.editMile').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#edit_no_of_rating').val(response.no_of_rating);
                        $('#edit_no_of_pickup').val(response.no_of_pickup);
