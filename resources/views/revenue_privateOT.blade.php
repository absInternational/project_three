...
@section('template_title')
    {{ ucfirst(trim('All Private Order Takers', '/')) }}
@endsection
...
@section('content')
    ...
    <div class="page-header">
        <div class="text-secondary text-center text-uppercase w-100">
            <h1 class="my-4"><b>All Private Order Takers</b></h1>
        </div>
    </div>
                ...
                <div class="card-header">
                    <div class="container-fluid">
                        <div class="d-flex justify-content-between">
                            <h3 class="my-auto">All Private Order Takers</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-sm" style="width:100%" role="grid">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">Average</th>
                            ...
                            <tbody>
                                @foreach ($data as $key => $val)
                                    <tr>
                                        ...
                                        <td>{{ number_format($val->commission) }}</td>
                                        <td>{{ $val->month }}</td>
                                        <td>
                ...
                <form id="addForm" class="addForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="cancellation_deduction"
                                name="cancellation_deduction">
                        </div>
                        <div class="form-group">
                            <label for="total_booked_order">Total Booked Orders</label>
                            <input type="number" class="form-control" id="total_booked_order"
            ...
            <div class="modal-content">
                ...
                <form id="editForm" class="editForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_average">Average</label>
                            <input type="text" class="form-control" id="edit_average" name="average">
                        </div>
                        <div class="form-group">
