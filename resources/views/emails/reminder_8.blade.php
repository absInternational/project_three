                                                                        ...
                                                                        <table align="left" cellspacing="0" cellpadding="0" border="0" class="midaling">
                                                                            ...
                                                                            @if($id == 1)
                                                                                @if($order->vtype != 3)
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Our records indicate that you requested a shipping quote #{{ $order->id }} to transport your
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="center">
                                                                                            We will be happy to address all your questions and help you Adjust a quote that will accommodate all your shipping needs.
                                                                                        </td>
                                                                                    </tr>
                                                                                @else
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Shipping heavy equipment is a difficult process that requires attention to detail, experience in hauling,
                                                                                            and the right tools and pieces of equipment to get it transported safely.
                                                                                            We gathered 24 best shipping agents and over <strong style="color: #000;">25000 reliable carriers</strong> for you.
                                                                                            For the past <strong style="color: #000;">10 years</strong>, our goal is to provide ultimately superior vehicle shipping experience for an affordable price.
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15">&nbsp;</td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Currently I see options to move your <strong style="color: #000;">{{ $order->heading }}</strong> from
                                                                                            <strong style="color: #000">{{ $order->ocity }}, {{ $order->ostate }} {{ $order->ozip }}</strong> to
                                                                                            <strong style="color: #000">{{ $order->dcity }}, {{ $order->dstate }} {{ $order->dzip }}</strong> in <strong style="color: #000;">${{ $order->payment }}</strong>.
                                                                            ...
                                                                            @elseif($id == 2)
                                                                                ...
                                                                                @else
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Currently I see options to move your <strong style="color: #000;">
                                                                                                @if($order->stype == 1 || $order->stype == "")
                                                                                                    @if(strpos($order->vmake, '^*-') !== false)
                                                                                                        <?php
                                                                                                        $make = explode('^*-',$order->vmake);
