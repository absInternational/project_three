                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="logo" style="text-align: center;">
                                <h1 style="text-align: center;"><a href="#">Review</a></h1>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding: 0 2.5em; text-align: left;">
                                <div class="text">
                                    <h4 style="text-align:center;">{{ $details['title'] }}</h4>
                                </div>
                            </td>
                        </tr>
                    </table>
                ...
                <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td valign="middle" style="text-align:center; padding: 1em 2.5em;">
                            <p style="text-align:center;">Website Link:</p>
                            <form action="{{url('/link-clicked')}}" method="GET" target="_blank">
                                @csrf
                                <input type="hidden" name="id" value="{{$details['id']}}" />
                                <input type="hidden" name="link" value="{{encrypt($details['link'])}}" />
                                <button class="btn btn-warning" type="submit" style="text-align:center;">{{$details['name']}}</button>
                            </form>
