                                                                        ...
                                                                        <table align="left" cellspacing="0" cellpadding="0" border="0" class="midaling">
                                                                            ...
                                                                            @if($id == 1)
                                                                                @if($order->vtype != 3)
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Thank you for your time and consideration of All state to state auto transport.
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15">&nbsp;</td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            ...
                                                                                            starts from <strong style="color: #000">${{ $order->payment }}</strong> right now, so don't hasitate and book a spot online right now.
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15">&nbsp;</td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            To deal with us means no payments upfront, door-to-door delivery and direct contact with reliable carriers with long-term experience.
                                                                                        </td>
                                                                                    </tr>
                                                                                @else
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Are you still trying to ship your {{ $order->heading }} from
                                                                                            <strong style="color: #000">{{ $order->ocity }}, {{ $order->ostate }} {{ $order->ozip }}</strong> to
                                                                                            <strong style="color: #000">{{ $order->dcity }}, {{ $order->dstate }} {{ $order->dzip }}</strong>?
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            When you need to ship your heavy equipment, you need a transporter who specializes in heavy hauls.
                                                                                            Here we’re <strong style="color: #000;">All State To State Auto Transport</strong> doing business since 2008.
                                                                                            We will help you find the best transporter for your equipment shipping.
                                                                                        </td>
                                                                                    </tr>
                                                                                @endif
                                                                            @elseif($id == 2)
