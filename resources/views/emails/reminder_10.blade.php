                                                                        ...
                                                                        <table align="left" cellspacing="0" cellpadding="0" border="0" class="midaling">
                                                                            ...
                                                                            @if($id == 1)
                                                                                @if($order->vtype != 3)
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            We have <strong style="color:#000">{{ rand(1,5) }} truckers</strong> near to your pick-up location who can pick up your
                                                                                            <strong style="color: #000">
                                                                                                ...
                                                                                                @else
                                                                                                    {{ $order->heading }}
                                                                                                @endif
                                                                                            </strong> within <strong style="color: #000">2 days</strong> from
                                                                                            ...
                                                                                            Price of <strong style="color: #000">${{ $order->payment }}</strong> You have provided all the necessary information regarding the Shipment; however,
                                                                                            <strong style="color: #000">
                                                                                                you did not complete the booking process.
                                                                                            </strong>
                                                                                        </td>
                                                                                    </tr>
                                                                                @else
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Are you still trying to ship your <strong style="color: #000;">{{ $order->heading }}</strong> from
                                                                                            <strong style="color: #000">{{ $order->ocity }}, {{ $order->ostate }} {{ $order->ozip }}</strong> to
                                                                                            <strong style="color: #000">{{ $order->dcity }}, {{ $order->dstate }} {{ $order->dzip }}</strong>?
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            The price to ship your <strong style="color: #000;">{{ $order->heading }}</strong> is <strong style="color: #000;">${{ $order->payment }}</strong>.
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15">&nbsp;</td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Your quote number is <strong style="color: #000">{{ $order->id }}</strong>. For your convenience, you can place your order online using the <strong style="color: #000;">Complete Booking</strong> Button below.
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15">&nbsp;</td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Communication is very important and we have very flexible payment terms and ensure a smooth process until the end. We appreciate the consideration and do hope to serve you now and, in the future.
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15">&nbsp;</td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Offers always welcomed within reason as our primary goal is to ensure that your items are picked up and delivered in a timely manners.
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15">&nbsp;</td>
                                                                            ...
                                                                            @elseif($id == 2)
                                                                                ...
                                                                                @else
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Are you still trying to ship your <strong style="color: #000;">
