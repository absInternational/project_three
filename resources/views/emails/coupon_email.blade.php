                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="logo" style="text-align: center;">
                                <h1 style="text-align: center;"><a href="#">Coupon</a></h1>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            <td style="padding: 0 2.5em; text-align: left;">
                                <div class="text">
                                    ...
                                    <h2 style="width:50%;margin:0 auto;text-align:center; background-color:black;color:white;padding:10px 25px;">${{ $details['price'] }}</h2>
                                </div>
                            </td>
                        </tr>
                    </table>
                ...
                <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td valign="middle" style="text-align:center; padding: 1em 2.5em;">
                            <p style="text-align:center;">Coupon Number:</p>
                            <p class="btn btn-primary" style="text-align:center;">{{$details['coupon']}}</p>
