                        ...
                        <table width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="mobile-width">
                            ...
                            <tr>
                                ...
                                <!-- Section 3 Start -->
                                                                ...
                                                                <tr>
                                                                    <td valign="top" align="center">
                                                                        ...
                                                                        <table align="center" cellspacing="0" cellpadding="0" border="0" class="midaling" style="width:100%">
                                                                            ...
                                                                            <tr>
                                                                                <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">We are glad to work with you. As requested, here is your quote to transport your
                                                                                ...
                                                                                <td style="font-size:13px; mso-line-height-rule:exactly;  line-height:16px; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="center">
                                                                                    <table class="table" align="center">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            @if($order->stype == 1 || $order->stype == 0)
                                                                                                <td>Vehicle :</td>
                                                                                            @elseif($order->stype == 2)
                                                                                                <td>Motorcycle :</td>
                                                                                            @elseif($order->stype == 3)
                                    ...
                                    <!-- Section 6 Start -->
                                @include('partials.email.ship_footer')
                                <!-- Section 6 End -->
                                </td>
                            </tr>
                            </tbody>
