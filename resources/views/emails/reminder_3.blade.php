                                                                    ...
                                                                    <td valign="top" align="center">
                                                                        ...
                                                                        <table align="left" cellspacing="0" cellpadding="0" border="0" class="midaling">
                                                                            ...
                                                                            @if($id == 1)
                                                                                @if($order->vtype == 3)
                                                                                    <tr>
                                                                                        <td style="font-size:11px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            {{ $order->heading }}
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="font-size:11px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Origin: {{ $order->ocity }}, {{ $order->ostate }} {{ $order->ozip }}
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="font-size:11px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Destination: {{ $order->dcity }}, {{ $order->dstate }} {{ $order->dzip }}
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                            ...
                                                                            @if($id == 1)
                                                                                ...
                                                                                @else
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            We have a large network of Drivers that cover the lower 48 states. We transport everything from Vehicle to Oversize loads.
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="15">&nbsp;</td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:13px; line-height: 20px; mso-line-height-rule:exactly; color:#414848; font-weight:normal; font-family: Open Sans, sans-serif;" align="left">
                                                                                            Our drivers are some of the best in the industry and have years of experience transporting all types of vehicles and heavy equipment.
                                                                                        </td>
                                                                                    </tr>
                                                                                @endif
                                                                            @elseif($id == 2)
