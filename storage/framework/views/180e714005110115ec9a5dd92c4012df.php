...
<?php $__env->startSection('template_title'); ?>
    <?php echo e(ucfirst(trim('Show Data','/'))); ?>
...
@import url('https://fonts.googleapis.com/css2?family=Poppins:wght@300&display=swap');
    ...
    <?php echo $__env->make('main.phone_quote.question.style', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    
    <?php echo $__env->make('main.phone_quote.question.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="page-header" style="margin-top: 30px !important;">
        ...
        <div class="tabMainbody">
            <?php if(\Request::segment(2) == 'searchData'): ?>
                <?php if($data): ?>
                    <?php echo $__env->make('main.phone_quote.question.data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            <?php endif; ?>
        </div>
        <input type="hidden" value="<?php echo e(\Request::segment(2)); ?>" class="route">
    </div>
...
<?php echo $__env->make('main.phone_quote.question.foot', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.innerpages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n0aa435/crm.roadya.com/resources/views/main/phone_quote/question/show-data.blade.php ENDPATH**/ ?>