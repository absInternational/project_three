...
<?php $__env->startSection('template_title'); ?>
    <?php echo e(ucfirst(trim('Filtered Data', '/'))); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 m-auto text-right" style="margin-top: 28px !important;">
                            <a href="<?php echo e(route('search.allNew.user')); ?>" type="button" class="btn btn-primary w-100">All
                                New User</a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 m-auto text-right" style="margin-top: 28px !important;">
                ...
                <div class="card-body">
                    ...
                    <div class="">
                        ...
                        <input type="hidden" value="<?php echo e(url('')); ?>" class="url">
                        <div id="table_data">
                                    ...
                                    <tbody class="showData">
                                        <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <a
                                                        href="/searchData?search=<?php echo e($value->id); ?>"><?php echo e($value->id); ?></a>
                                                </td>
                                                <?php
                                                $name = '';
                                                ...
                                                <td><?php echo e($value->oname); ?></td>
                                                <td><?php echo e($value->destinationcity); ?></td>
                                                <td><?php echo e($value->destinationzip); ?></td>
                                                <td><?php echo e($value->ymk); ?></td>
                                                <td><?php echo e(get_pstatus($value->pstatus)); ?></td>
                                                <td>Created At:
                                                    <br><?php echo e(\Carbon\Carbon::parse($value->created_at)->format('M,d Y')); ?><br><?php echo e(\Carbon\Carbon::parse($value->created_at)->format('h:i A')); ?>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="text-secondary my-auto">
                                    Showing <?php echo e($order->firstItem() ?? 0); ?> to <?php echo e($order->lastItem() ?? 0); ?> from total
                                    <?php echo e($order->total()); ?> entries
                                </div>
                                <div class="pagi">
    ...
    //                 `);
        ...
        $(document).ready(function() {
            ...
            function filteredData(page) {
                ...
                $.ajax({
                    url: "<?php echo e(url('/filtered-data')); ?>?page=" + page,
                    type: "GET",
                    data: {
...
<?php echo $__env->make('layouts.innerpages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n0aa435/crm.roadya.com/resources/views/main/filtered/index.blade.php ENDPATH**/ ?>