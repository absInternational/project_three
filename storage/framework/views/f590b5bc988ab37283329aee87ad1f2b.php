<?php $__env->startSection('template_title'); ?>
    <?php echo e(ucfirst(trim("$_SERVER[REQUEST_URI]", '/'))); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-header">
        ...
        <div class="text-secondary text-center text-uppercase w-100">
            <h1 class="my-4"><b>Day Dispatch | <?php echo e($data_type); ?></b></h1>
        </div>
    </div>
    <!--End Page header-->
    <!-- Row -->
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                ?>
                <?php if(in_array('136', $phoneaccess) || Auth::user()->role == 1 || Auth::user()->role == 9 || in_array('143', $phoneaccess)): ?>
                    <?php if(Auth::user()->role == 1 || Auth::user()->role == 9 || in_array('143', $phoneaccess)): ?>
                        <div class="card-header">
                            <div class="container-fluid">
                                <div class="col-lg-12 p-0">
                                        ...
                                        ?>
                                    <form method="post" action="<?php echo e(route('store.autos.approach_new')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="row">
                                            <div class="col-lg-3">
                                               ...
                                               <select id="type" name="type" class="form-control type" required>
                                                    ...
                                                    <option value="<?php echo e($data_type == 'Shipper' ? 1 : ($data_type == 'Carrier' ? 2 : ($data_type == 'Broker' ? 3 : ''))); ?>">
                                                        <?php echo e($data_type); ?>
                                                    ...
                                                    <select name="orderTaker" class="form-control" id="orderTaker" required>
                                                        ...
                                                        <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($val->id); ?>">
                                                                <?php echo e($val->name . ' ' . $val->last_name); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select id="stateComp" name="stateComp[]" class="form-control" required>
                                                <option selected value="">Select</option>
                                                <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($val->states); ?>">
                                    ...
                                    <div class="col-lg-2 mt-auto">
                                        <a class="btn btn-primary" href="<?php echo e(route('all.autos.autos_approach_new')); ?>">
                ...
                <?php if(in_array('96', $phoneaccess)): ?>
                    <div class="card-header">
                        <div class="container-fluid">
                            <div class="col-lg-12 p-0">
                                    <?php
                ...
                <div class="card-body">
                    <div id="table_data">
                        ...
                        <?php echo $__env->make('main.phone_quote.ShipperDetails.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="panel-body tabs-menu-body">
                                <div class="tab-content">
                                    <div class="tab-pane active " id="tab1">
                                        <form method="post" action="<?php echo e(route('call_history_post_2')); ?>">
                                            <?php echo csrf_field(); ?>
                                            <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="modal-body history-content">
                                <form action="<?php echo e(route('Admin.autos_approach_new.Store')); ?>" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="state_add" class="form-control" id="state_add">
                                            ...
                                            <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($val->states); ?>">
                                                    <?php echo e($val->states . ' ' . '(' . $val->total . ')'); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
<?php $__env->startSection('extraScript'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            var all_states = <?php echo json_encode($datas, 15, 512) ?>;
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var statesString = '<?php echo e($state); ?>';
    ...
    <script>
        ...
        function fetchData(page) {
            ...
            $.ajax({
                url: '<?php echo e(route('autos.approach_new.search')); ?>' + '?page=' + page,
                type: 'GET',
                data: {
                    state: stateValue,
                    search: searchValue,
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateSuggestions(inputField, suggestionsList) {
                ...
                $.ajax({
                    url: '<?php echo e(route('autos_approach_new.validation.check')); ?>',
                    method: 'POST',
                    data: {
    ...
    <script>
        $(document).ready(function() {
            $('#withHistory').change(function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('autos.approach_new.search')); ?>',
                    type: 'GET',
                    data: {
    ...
    <script>
        $(document).on('click', '.send-email', function(event) {
            ...
            $.ajax({
                url: '<?php echo e(route('send.user.mail')); ?>',
                type: 'GET',
                data: {
                    email: email,
                },
        ...
        $(document).on('click', '.view_email_history', function(event) {
            ...
            $.ajax({
                url: '<?php echo e(route('get.email.history')); ?>',
                type: 'GET',
                data: {
                    'email': email,
                },
...
<?php echo $__env->make('layouts.innerpages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project_three\resources\views/main/phone_quote/ShipperDetails/index.blade.php ENDPATH**/ ?>