...
<script>
    ...
    $(document).ready(function() {
        ...
        var route = "<?php echo e(\Request::segment(2)); ?>";
        function index(page,limit,searchIn,search) 
        {
            var global_search = $('.global').val();
            $.ajax({
                url:"<?php echo e(url('/searchFilter?page=')); ?>"+page,
                type: "GET",
                // dataType: "json",
...
<?php /**PATH /home/n0aa435/crm.roadya.com/resources/views/main/phone_quote/question/foot.blade.php ENDPATH**/ ?>