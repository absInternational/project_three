            ...
            <div class="">
                <ul class="side_nav_style" id="style-14">
                    ...
                    <?php endif; ?>
                        ...
                        <li>
                            <a class="side-menu__item" href="<?php echo e(route('links')); ?>">
                                <span
                                    class="js-search-result-thumbnail responsive-img img_border fa fa-question"></span>
                    ...
                    <?php endif; ?>
                    <?php if(Auth::user()->userRole->name == 'Admin' || in_array('124', $phoneaccess)): ?>
                        <li>
                    ...
                    <?php endif; ?>
                    <?php if(Auth::user()->userRole->name == 'Admin' || in_array('123', $phoneaccess)): ?>
                        <li>
                    ...
                    <?php if(in_array('32', $phoneaccess)): ?>
                        ...
                        <li>
                            <a style="background: #2dd1ba8c" class="side-menu__item"
                                href="<?php echo e(url('/reports/get')); ?>">
                                <span class="js-search-result-thumbnail responsive-img img_border fa fa-file"></span>
                    ...
                    <?php if(in_array('30', $phoneaccess)): ?>
                        <li>
                            <a style="background: #2dd1ba8c" class="side-menu__item"
                                href="<?php echo e(url('approaching')); ?>">
                                <span class="js-search-result-thumbnail responsive-img img_border fa fa-mobile"></span>
