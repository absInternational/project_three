            ...
            <?php if(Auth::user()->role < 6 || Auth::user()->role > 7): ?>
             ...
             <ul class="header_social m-0 ml-2">
                ...
                <div class="header__btn">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style=" margin-left: -22px; height: 350px; overflow: scroll; ">
                            <?php if(in_array("131", $phoneaccess) || Auth::user()->userRole->name == 'Admin'): ?>
                                <a class="dropdown-item" href="<?php echo e(route('cpanelemails.index')); ?>"><i
               ...
               <div class="header_ri">
                            ...
                            <a class="dropdown-item border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                                        <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="<?php echo e(url('assets/images/users/2.jpg')); ?>"></span>
                                    </div>
                                    <div class="d-flex">
                                        <div class="pl-3">
                            ...
                            <a class="dropdown-item border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                                        <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="<?php echo e(url('assets/images/users/3.jpg')); ?>"></span>
                                    </div>
                                    <div class="d-flex">
                                        <div class="pl-3">
                            ...
                            <a class="dropdown-item border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                                        <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="<?php echo e(url('assets/images/users/4.jpg')); ?>"></span>
                                    </div>
                                    <div class="d-flex">
                                        <div class="pl-3">
                            ...
                            <a class="dropdown-item border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                                        <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="<?php echo e(url('assets/images/users/6.jpg')); ?>"></span>
                                    </div>
                                    <div class="d-flex">
                                        <div class="pl-3">
                            ...
                            <a class="dropdown-item border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                                        <span
                                                                class="avatar avatar-md brround align-self-center cover-image"
                                                                data-image-src="<?php echo e(url('assets/images/users/7.jpg')); ?>"></span>
                                    </div>
                                    <div class="d-flex">
                                        <div class="pl-3">
                ...
                <?php if(Auth::user()->userRole->name == 'Check Price'): ?>
                    <?php
                    ...
                    <div class="dropdown header-notify">
                        <a class="nav-link icon" data-toggle="dropdown">
                            ...
                            <span class="badge badge-danger side-badge" style="width: 25px; height: 25px; justify-content: center; align-items: center; display: flex !important; right: -10px; top: -10px;" id="notify_count"><?php echo e(count($data)); ?></span>
                                ...
                                <a href="javascript:void(0)" class="dropdown-item border-bottom d-flex pl-4">
                                    ...
                                    <div>
                                        <div class="font-weight-normal1">
                                            New request for : ORDER ID : <?php echo e($val2->order_id); ?>
...
<script>
    $(document).ready(function () {
        function fetchNotifications() {
            $.ajax({
                url: "<?php echo e(route('fetch.notifications')); ?>", // Replace with your route for fetching notifications
                method: "GET",
...
<?php /**PATH C:\xampp\htdocs\project_three\resources\views/partials/mainsite_pages/nav.blade.php ENDPATH**/ ?>