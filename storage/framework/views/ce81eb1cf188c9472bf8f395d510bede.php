...
<head>
    ...
    <?php echo $__env->make('partials.mainsite_p.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<body class="app sidebar-mini">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <?php echo $__env->make('partials.mainsite_p.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            

            <div class="app-content main-content">
                <div class="side-app">
                    <!--nav header-->
                    <?php echo $__env->make('partials.mainsite_p.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!--/nav header-->
                    <br>
                    <div id="session_msg">
...
Agent: Thank you for your cooperation. We appreciate your attention to these details. Have a safe and successful transport, and please don't hesitate to reach out if you have any further questions or concerns. Have a great day!
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © <?php echo e(date('Y')); ?> <a href="<?php echo e(url('/dashboard')); ?>">SHIPA1</a>. Designed By <a
                            href="<?php echo e(url('/dashboard')); ?>">SHIPA1
    ...
    <?php echo $__env->make('partials.mainsite_p.foot', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\project_three\resources\views/layouts/mainsite.blade.php ENDPATH**/ ?>